...
struct Bandori_memberView3: View {

 @State private var bandori_members = [Bandori_member]()

 func fetchBandori_members() {
     let urlStr = "https://bandori.party/api/members/?page=3"
...
struct Bandori_memberView3_Previews: PreviewProvider {
