...
struct Bandori_memberView2: View {

 @State private var bandori_members = [Bandori_member]()

 func fetchBandori_members() {
     let urlStr = "https://bandori.party/api/members/?page=2"
...
struct Bandori_memberView2_Previews: PreviewProvider {
